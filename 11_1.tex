...
\begin{enumerate}
    ...
    \begin{center}
        \fbox{$\alpha = - \frac{1}{\sigma} \frac{d \sigma}{d T} = (29 \pm 0.3) \cdot 10^{-4} \; (1/K)\; [\pm 1.1 \%]$}
    \end{center}
    ...
    \item Коэффициент наклона $\alpha \approx -4175 \;(K)$.
        ...
        \begin{center}
            \fbox{$\Delta = -2k_b\cdot a = (830 \pm 8)\cdot 10^{-3} \; (эВ) \; [\pm 0.9\%]$}
        \end{center}
        
        Действительная ширина запрещенной зоны для Германия $\Delta_{Ge} \approx 0.67\; эВ$
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale = 0.85]{11_1_exp.png}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale = 0.215]{11_1_Cu-1.png}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale = 0.215]{11_1_Ge-1.png}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale = 0.215]{11_1_main-1.png}
